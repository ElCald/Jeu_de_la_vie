 ...
 */
Window::Window(const size_t _win_width, const size_t _win_height) : nb_frames(0), win_width(_win_width), win_height(_win_height), animationEnable(false), visibleTextZones(false), delay_animation(FRAME_DELAY_ANIMATION) {
